...
hi Search   ctermfg=236   ctermbg=228  guifg=#000000   guibg=#FFFF8C   gui=bold
hi Folded   ctermfg=8 ctermbg=15 guifg=#808080 guibg=#ECECEC gui=bold
hi Title    ctermfg=167 guifg=#ef5939
hi StatusLine ctermfg=238 ctermbg=250 guifg=#404040 guibg=#bbbbbb gui=bold
...
hi LineNr   ctermfg=246 ctermbg=15 guifg=#959595 guibg=#ECECEC gui=bold
...
if version >= 700
    ...
    hi Pmenu        ctermfg=15 ctermbg=8 guifg=#ffffff guibg=#808080 gui=bold
...
hi PreProc  ctermfg=247 guifg=#A0A0A0 gui=bold
...
hi Function ctermfg=88 guifg=#990000 gui=bold
hi Statement    ctermfg=0 guifg=#000000 gui=bold
hi Type     ctermfg=60 guifg=#445588 gui=bold
hi Number   ctermfg=30 guifg=#1C9898
hi Todo     ctermfg=15 ctermbg=88 guifg=#FFFFFF guibg=#990000 gui=bold
hi Special  ctermfg=28 guifg=#159828 gui=bold
hi Todo         ctermbg=15 ctermfg=196 guibg=#f8f8ff guifg=#ff1100 gui=underline cterm=underline
hi Label        ctermfg=0 guifg=#000000 gui=bold
hi StorageClass ctermfg=0 guifg=#000000 gui=bold
hi Structure    ctermfg=0 guifg=#000000 gui=bold
hi TypeDef      ctermfg=0 guifg=#000000 gui=bold
